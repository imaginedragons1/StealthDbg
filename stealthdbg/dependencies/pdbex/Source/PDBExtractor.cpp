...
#include "StealthDbgExport.h"
#include "StealthDbgGlobals.h"
...
PDBExtractor::PrintPDBHeader()
{
    if (m_Settings.PrintHeader)
    {
        static const char * const ArchitectureString =
            m_PDB.GetMachineType() == IMAGE_FILE_MACHINE_I386 ? "i386" : m_PDB.GetMachineType() == IMAGE_FILE_MACHINE_AMD64  ? "AMD64"
