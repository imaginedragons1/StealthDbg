 ...
 *
 */
BOOLEAN g_IsConnectedToStealthDbgLocally = FALSE;
 ...
 * it is because in StealthDbg, debuggee is server and debugger
 * is a client
 *
 */
 ...
 * it is because in StealthDbg, debugger is client and debuggee
 * is a server
 *
 */
 ...
 *
 * @details this list is not have any relation with the things that StealthDbg
...
/**
 * @brief Holds the location test-StealthDbg.exe
 *
 */
