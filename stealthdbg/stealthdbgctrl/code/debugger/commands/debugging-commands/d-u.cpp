...
CommandReadMemoryAndDisassembler(vector<string> SplittedCommand, string Command)
{
    ...
    {
        StealthDbgReadMemoryAndDisassemble(DEBUGGER_SHOW_COMMAND_DB,
                                           TargetAddress,
    ...
    {
        StealthDbgReadMemoryAndDisassemble(DEBUGGER_SHOW_COMMAND_DC,
                                           TargetAddress,
                                           DEBUGGER_READ_VIRTUAL_ADDRESS,
                                           READ_FROM_KERNEL,
                                           Pid,
    ...
    {
        StealthDbgReadMemoryAndDisassemble(DEBUGGER_SHOW_COMMAND_DD,
                                           TargetAddress,
                                           DEBUGGER_READ_VIRTUAL_ADDRESS,
                                           READ_FROM_KERNEL,
                                           Pid,
    ...
    {
        StealthDbgReadMemoryAndDisassemble(DEBUGGER_SHOW_COMMAND_DQ,
                                           TargetAddress,
                                           DEBUGGER_READ_VIRTUAL_ADDRESS,
                                           READ_FROM_KERNEL,
                                           Pid,
    ...
    {
        StealthDbgReadMemoryAndDisassemble(
