...
/**
 * @brief Convert StealthDbg arguments for dt and struct commands to pdbex arguments
 ...
 */
BOOLEAN
CommandDtAndStructConvertStealthDbgArgsToPdbex(vector<string> ExtraArgs,
    ...
    const char * AdditionalParameters)
{
    ...
    if (Address != NULL)
    {
        ...
        // Read the memory
        //
        StealthDbgReadMemoryAndDisassemble(DEBUGGER_SHOW_COMMAND_DT,
                                           Address,
    ...
    else
    {
                                                          ...
                                                          &TargetAddress))
        {
                                                              ...
                                                              &TargetAddress))
            {
                ...
                //
                if (!CommandDtAndStructConvertStealthDbgArgsToPdbex(TempSplittedCommand, PdbexArgs, &TargetPid))
                {
                    if (IsStruct)
                    {
                        CommandStructHelp();
