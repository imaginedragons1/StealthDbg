...
CommandUnload(vector<string> SplittedCommand, string Command)
{
    ...
    {
        if (!g_IsConnectedToStealthDbgLocally)
        {
            ShowMessages("you're not connected to any instance of StealthDbg, did you "
                         "use '.connect'? \n");
            return;
        }
