...
StartAgain:
        ...
        case DEBUGGER_REMOTE_PACKET_REQUESTED_ACTION_DEBUGGEE_PAUSED_AND_CURRENT_INSTRUCTION:
                ...
                DEBUGGEE_PAUSING_REASON_PAUSE_WITHOUT_DISASM)
            {
                ...
                if (PausePacket->ReadInstructionLen != MAXIMUM_INSTR_SIZE)
                {
                    ...
                    //
                    if (StealthDbgLengthDisassemblerEngine(PausePacket->InstructionBytesOnRip,
                                                           MAXIMUM_INSTR_SIZE,
                ...
                if (!PausePacket->Is32BitAddress)
                {
                    ...
                    // Show diassembles
                    //
                    StealthDbgDisassembler64(PausePacket->InstructionBytesOnRip,
                                             PausePacket->Rip,
                                             MAXIMUM_INSTR_SIZE,
                                             1,
                                             TRUE,
                ...
                else
                {
                    ...
                    // Show diassembles
                    //
                    StealthDbgDisassembler32(PausePacket->InstructionBytesOnRip,
                                             PausePacket->Rip,
                                             MAXIMUM_INSTR_SIZE,
                                             1,
                                             TRUE,
        ...
        case DEBUGGER_REMOTE_PACKET_REQUESTED_ACTION_DEBUGGEE_RESULT_OF_READING_MEMORY:
                ...
                DEBUGGER_OPERATION_WAS_SUCCESSFULL)
            {
                ...
                case DEBUGGER_SHOW_COMMAND_DISASSEMBLE64:
                    ...
                    // Show diassembles
                    //
                    StealthDbgDisassembler64(MemoryBuffer, ReadMemoryPacket->Address, ReadMemoryPacket->ReturnLength, 0, FALSE, NULL);
                ...
                case DEBUGGER_SHOW_COMMAND_DISASSEMBLE32:
                    ...
                    // Show diassembles
                    //
                    StealthDbgDisassembler32(MemoryBuffer, ReadMemoryPacket->Address, ReadMemoryPacket->ReturnLength, 0, FALSE, NULL);
    ...
    {
        //
        // It's not a StealthDbg packet, it's probably a GDB packet
        //
