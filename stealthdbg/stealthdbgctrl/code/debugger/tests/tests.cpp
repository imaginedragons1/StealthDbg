                                   ...
                                   PHANDLE ProcessHandle)
{
    ...
    char *              BufferToRead;
    char *              BufferToSend;
    char                HandshakeBuffer[] = "Hello, Dear Test Process... Yes, I'm StealthDbg Debugger :)";
    PROCESS_INFORMATION ProcessInfo;
    STARTUPINFO         StartupInfo;
    char                CmdArgs[] = TEST_PROCESS_NAME " im-StealthDbg";

    PipeHandle = NamedPipeServerCreatePipe("\\\\.\\Pipe\\StealthDbgTests",
    ...
    if (CreateProcess(g_TestLocation, CmdArgs, NULL, NULL, FALSE, CREATE_NEW_CONSOLE, NULL, NULL, &StartupInfo, &ProcessInfo))
    {
        ...
        if (strcmp(BufferToRead, "Hey there, Are you StealthDbg?") == 0)
        {
            //
