 ...
 * @brief StealthDbg command for u and d*
 * @details
 * @version 0.1
 * @date 2020-05-27
 *
                                   ...
                                   PDEBUGGER_DT_COMMAND_OPTIONS DtDetails)
{
    ...
    case DEBUGGER_SHOW_COMMAND_DISASSEMBLE64:
        ...
        // Show diassembles
        //
        StealthDbgDisassembler64(OutputBuffer, Address, ReturnedLength, 0, FALSE, NULL);
    ...
    case DEBUGGER_SHOW_COMMAND_DISASSEMBLE32:
        ...
        // Show diassembles
        //
        StealthDbgDisassembler32(OutputBuffer, Address, ReturnedLength, 0, FALSE, NULL);
