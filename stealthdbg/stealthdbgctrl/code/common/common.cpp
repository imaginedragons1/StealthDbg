 ...
 * @file common.cpp
 * @author anonymous
 * @brief StealthDbg general functions for reading and converting and etc
 * @details
 * @version 0.1
 * @date 2020-05-27
 *
...
CheckMemoryAccessSafety(UINT64 TargetAddress, UINT32 Size)
{
    ...
    else
    {
        ...
        // StealthDbg's script engine is not designed to be runned these functions in user-mode
