 ...
 */
VOID
StealthDbgSetTextMessageCallback(Callback handler)
{
...
StealthDbgUnload()
{
    ...
    ShowMessages("you're not on StealthDbg's hypervisor anymore!\n");
