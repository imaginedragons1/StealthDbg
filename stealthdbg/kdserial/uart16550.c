...
VOID
KdStealthDbgPrepareDebuggeeConnectionPort(UINT32 PortAddress, UINT32 Baudrate)
{
...
VOID
KdStealthDbgSendByte(UCHAR Byte, BOOLEAN BusyWait)
{
    Uart16550PutByte(&g_PortDetails, Byte, BusyWait);
}

BOOLEAN
KdStealthDbgRecvByte(PUCHAR RecvByte)
{
